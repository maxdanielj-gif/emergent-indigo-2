...
const AIProfileScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setGeminiTtsModel(aiProfile.geminiTtsModel || 'gemini-3.1-flash-tts');
  ...
  const [geminiTtsModel, setGeminiTtsModel] = useState<string>(aiProfile.geminiTtsModel || 'gemini-3.1-flash-tts');
                            ...
                            {voiceProvider === 'gemini' && (
                                <div className="p-4 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800 rounded-lg space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                    ...
                                    <div>
                                        ...
                                        >
                                            <option value="gemini-3.1-flash-tts">Gemini 2.5 Flash (Fast, efficient)</option>
